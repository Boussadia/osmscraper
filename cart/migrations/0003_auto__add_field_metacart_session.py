...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MetaCart.session'
        db.add_column(u'cart_metacart', 'session',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sessions.Session'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MetaCart.session'
        db.delete_column(u'cart_metacart', 'session_id')
    ...
    models = {
        ...
        u'cart.metacart': {
            ...
            'session': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sessions.Session']", 'null': 'True'})
        },
        u'dalliz.category': {
            'Meta': {'unique_together': "(('name', 'parent_category'),)", 'object_name': 'Category'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
