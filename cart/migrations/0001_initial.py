...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MetaCart'
        db.create_table(u'cart_metacart', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('monoprix_cart', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['monoprix.Cart'])),
            ('auchan_cart', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auchan.Cart'])),
            ('ooshop_cart', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ooshop.Cart'])),
            ('current_osm', self.gf('django.db.models.fields.CharField')(default='monoprix', max_length=100)),
        ))
        db.send_create_signal(u'cart', ['MetaCart'])


    def backwards(self, orm):
        # Deleting model 'MetaCart'
        db.delete_table(u'cart_metacart')
    ...
    models = {
        ...
        u'cart.metacart': {
            ...
            'auchan_cart': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auchan.Cart']"}),
            'current_osm': ('django.db.models.fields.CharField', [], {'default': "'monoprix'", 'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'monoprix_cart': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['monoprix.Cart']"}),
            'ooshop_cart': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ooshop.Cart']"})
        },
        u'dalliz.category': {
            'Meta': {'unique_together': "(('name', 'parent_category'),)", 'object_name': 'Category'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
