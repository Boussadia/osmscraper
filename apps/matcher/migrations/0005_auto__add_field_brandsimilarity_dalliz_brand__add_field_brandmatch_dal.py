...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BrandSimilarity.dalliz_brand'
        db.add_column(u'matcher_brandsimilarity', 'dalliz_brand',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dalliz.NewBrand'], null=True),
                      keep_default=False)

        # Adding field 'BrandMatch.dalliz_brand'
        db.add_column(u'matcher_brandmatch', 'dalliz_brand',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dalliz.NewBrand'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BrandSimilarity.dalliz_brand'
        db.delete_column(u'matcher_brandsimilarity', 'dalliz_brand_id')

        # Deleting field 'BrandMatch.dalliz_brand'
        db.delete_column(u'matcher_brandmatch', 'dalliz_brand_id')
    ...
    models = {
        ...
        u'apps.matcher.brandmatch': {
            ...
            'auchan_brand': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auchan.Brand']", 'unique': 'True', 'null': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'dalliz_brand': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dalliz.NewBrand']", 'unique': 'True', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'monoprix_brand': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['monoprix.NewBrand']", 'unique': 'True', 'null': 'True'}),
            'ooshop_brand': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ooshop.NewBrand']", 'unique': 'True', 'null': 'True'})
        },
