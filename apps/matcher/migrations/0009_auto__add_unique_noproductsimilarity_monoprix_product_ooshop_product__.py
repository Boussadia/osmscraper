...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'NoProductSimilarity', fields ['monoprix_product', 'ooshop_product']
        db.create_unique(u'matcher_noproductsimilarity', ['monoprix_product_id', 'ooshop_product_id'])

        # Adding unique constraint on 'NoProductSimilarity', fields ['monoprix_product', 'auchan_product']
        db.create_unique(u'matcher_noproductsimilarity', ['monoprix_product_id', 'auchan_product_id'])

        # Adding unique constraint on 'NoProductSimilarity', fields ['auchan_product', 'ooshop_product']
        db.create_unique(u'matcher_noproductsimilarity', ['auchan_product_id', 'ooshop_product_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'NoProductSimilarity', fields ['auchan_product', 'ooshop_product']
        db.delete_unique(u'matcher_noproductsimilarity', ['auchan_product_id', 'ooshop_product_id'])

        # Removing unique constraint on 'NoProductSimilarity', fields ['monoprix_product', 'auchan_product']
        db.delete_unique(u'matcher_noproductsimilarity', ['monoprix_product_id', 'auchan_product_id'])

        # Removing unique constraint on 'NoProductSimilarity', fields ['monoprix_product', 'ooshop_product']
        db.delete_unique(u'matcher_noproductsimilarity', ['monoprix_product_id', 'ooshop_product_id'])
