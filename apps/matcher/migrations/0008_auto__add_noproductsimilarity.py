...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NoProductSimilarity'
        db.create_table(u'matcher_noproductsimilarity', (
        ...
        db.send_create_signal(u'matcher', ['NoProductSimilarity'])


    def backwards(self, orm):
        # Deleting model 'NoProductSimilarity'
        db.delete_table(u'matcher_noproductsimilarity')
    ...
    models = {
        ...
        u'apps.matcher.noproductsimilarity': {
            'Meta': {'object_name': 'NoProductSimilarity'},
