...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('telemarket_product', 'reference', self.gf('django.db.models.fields.CharField')(default=None, unique=True, max_length=9999))

    def backwards(self, orm):

        # Changing field 'Product.reference'
        db.alter_column('telemarket_product', 'reference', self.gf('django.db.models.fields.CharField')(unique=True, max_length=9999, null=True))
