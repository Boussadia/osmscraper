...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('telemarket_product', 'reference', self.gf('django.db.models.fields.CharField')(max_length=9999, null=True))

    def backwards(self, orm):

        # Changing field 'Product.reference'
        db.alter_column('telemarket_product', 'reference', self.gf('django.db.models.fields.IntegerField')(null=True))
