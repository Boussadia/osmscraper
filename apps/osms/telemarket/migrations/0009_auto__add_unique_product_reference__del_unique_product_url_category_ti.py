...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Product', fields ['url', 'category', 'title']
        db.delete_unique('telemarket_product', ['url', 'category_id', 'title'])

        # Adding unique constraint on 'Product', fields ['reference']
        db.create_unique('telemarket_product', ['reference'])


    def backwards(self, orm):
        # Removing unique constraint on 'Product', fields ['reference']
        db.delete_unique('telemarket_product', ['reference'])

        # Adding unique constraint on 'Product', fields ['url', 'category', 'title']
        db.create_unique('telemarket_product', ['url', 'category_id', 'title'])
