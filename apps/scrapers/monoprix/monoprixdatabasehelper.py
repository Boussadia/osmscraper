...
from apps.scrapers.base.basedatabasehelper import BaseDatabaseHelper
	...
	def save_categories(self, categories, id_parent_category = None):
		...
		for i in xrange(len(categories)):
			...
			if id_parent_category:
				category_db, created = Category.objects.get_or_create(url = url, name = name, parent_category_id =  id_parent_category)
			else:
