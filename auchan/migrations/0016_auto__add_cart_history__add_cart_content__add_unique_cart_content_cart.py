...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'auchan_cart_history', (
        ...
        db.send_create_signal(u'auchan', ['Cart_history'])

        # Adding model 'Cart_content'
        db.create_table(u'auchan_cart_content', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cart', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auchan.Cart'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auchan.Product'])),
            ('quantity', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'auchan', ['Cart_content'])

        # Adding unique constraint on 'Cart_content', fields ['cart', 'product']
        db.create_unique(u'auchan_cart_content', ['cart_id', 'product_id'])

        # Adding model 'Cart'
        db.create_table(u'auchan_cart', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('osm', self.gf('django.db.models.fields.CharField')(default='auchan', max_length=9999)),
        ))
        db.send_create_signal(u'auchan', ['Cart'])


    def backwards(self, orm):
        # Removing unique constraint on 'Cart_content', fields ['cart', 'product']
        db.delete_unique(u'auchan_cart_content', ['cart_id', 'product_id'])

        # Deleting model 'Cart_history'
        db.delete_table(u'auchan_cart_history')

        # Deleting model 'Cart_content'
        db.delete_table(u'auchan_cart_content')

        # Deleting model 'Cart'
        db.delete_table(u'auchan_cart')
