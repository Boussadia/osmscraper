...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'auchan_cart_history', 'cart',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auchan.Cart']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cart_history.cart'
        db.delete_column(u'auchan_cart_history', 'cart_id')
