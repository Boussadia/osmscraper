...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Brand.parent_brand'
        db.add_column(u'auchan_brand', 'parent_brand',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auchan.Brand'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Brand.parent_brand'
        db.delete_column(u'auchan_brand', 'parent_brand_id')
