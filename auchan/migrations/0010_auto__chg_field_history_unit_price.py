...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'auchan_history', 'unit_price', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'History.unit_price'
        db.alter_column(u'auchan_history', 'unit_price', self.gf('django.db.models.fields.FloatField')(default=0))
