...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cart_content.monoprix_content'
        db.alter_column(u'auchan_cart_content', 'monoprix_content_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['monoprix.Cart_content']))

        # Changing field 'Cart_content.ooshop_content'
        db.alter_column(u'auchan_cart_content', 'ooshop_content_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['ooshop.Cart_content']))

    def backwards(self, orm):

        # Changing field 'Cart_content.monoprix_content'
        db.alter_column(u'auchan_cart_content', 'monoprix_content_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['monoprix.Cart_content']))

        # Changing field 'Cart_content.ooshop_content'
        db.alter_column(u'auchan_cart_content', 'ooshop_content_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['ooshop.Cart_content']))
