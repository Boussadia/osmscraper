...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'auchan_cart_content', 'is_user_added',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Cart_content.is_match'
        db.add_column(u'auchan_cart_content', 'is_match',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Cart_content.is_suggested'
        db.add_column(u'auchan_cart_content', 'is_suggested',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Cart_content.is_user_set'
        db.add_column(u'auchan_cart_content', 'is_user_set',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Cart_content.monoprix_content'
        db.add_column(u'auchan_cart_content', 'monoprix_content',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='auchan_monoprix_related_content', null=True, to=orm['monoprix.Cart_content']),
                      keep_default=False)

        # Adding field 'Cart_content.ooshop_content'
        db.add_column(u'auchan_cart_content', 'ooshop_content',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='auchan_ooshop_related_content', null=True, to=orm['ooshop.Cart_content']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cart_content.is_user_added'
        db.delete_column(u'auchan_cart_content', 'is_user_added')

        # Deleting field 'Cart_content.is_match'
        db.delete_column(u'auchan_cart_content', 'is_match')

        # Deleting field 'Cart_content.is_suggested'
        db.delete_column(u'auchan_cart_content', 'is_suggested')

        # Deleting field 'Cart_content.is_user_set'
        db.delete_column(u'auchan_cart_content', 'is_user_set')

        # Deleting field 'Cart_content.monoprix_content'
        db.delete_column(u'auchan_cart_content', 'monoprix_content_id')

        # Deleting field 'Cart_content.ooshop_content'
        db.delete_column(u'auchan_cart_content', 'ooshop_content_id')
