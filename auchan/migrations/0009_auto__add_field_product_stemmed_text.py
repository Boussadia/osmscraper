...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.stemmed_text'
        db.add_column(u'auchan_product', 'stemmed_text',
                      self.gf('django.db.models.fields.TextField')(max_length=9999999999999999999999L, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.stemmed_text'
        db.delete_column(u'auchan_product', 'stemmed_text')
