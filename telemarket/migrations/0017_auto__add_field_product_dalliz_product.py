...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('telemarket_product', 'dalliz_product',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='telemarket_product_dalliz_product', null=True, to=orm['dalliz.Product']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.dalliz_product'
        db.delete_column('telemarket_product', 'dalliz_product_id')
