...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('telemarket_product', 'price')

        # Deleting field 'Product.unit'
        db.delete_column('telemarket_product', 'unit_id')

        # Deleting field 'Product.unit_price'
        db.delete_column('telemarket_product', 'unit_price')

        # Deleting field 'Product.promotion'
        db.delete_column('telemarket_product', 'promotion_id')


    def backwards(self, orm):
        # Adding field 'Product.price'
        db.add_column('telemarket_product', 'price',
                      self.gf('django.db.models.fields.FloatField')(default=None),
                      keep_default=False)

        # Adding field 'Product.unit'
        db.add_column('telemarket_product', 'unit',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['telemarket.Unit']),
                      keep_default=False)

        # Adding field 'Product.unit_price'
        db.add_column('telemarket_product', 'unit_price',
                      self.gf('django.db.models.fields.FloatField')(default=None),
                      keep_default=False)

        # Adding field 'Product.promotion'
        db.add_column('telemarket_product', 'promotion',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['telemarket.Promotion']),
                      keep_default=False)
