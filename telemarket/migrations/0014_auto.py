...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('telemarket_product_category', (
        ...
        db.create_unique('telemarket_product_category', ['product_id', 'category_final_id'])


    def backwards(self, orm):
        # Removing M2M table for field category on 'Product'
        db.delete_table('telemarket_product_category')
