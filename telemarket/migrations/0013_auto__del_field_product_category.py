...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('telemarket_product', 'category_id')


    def backwards(self, orm):
        # Adding field 'Product.category'
        db.add_column('telemarket_product', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['telemarket.Category_final']),
                      keep_default=False)
    ...
    models = {
        ...
        'telemarket.product': {
            ...
            'product_category': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'product_category_temp'", 'symmetrical': 'False', 'to': "orm['telemarket.Category_final']"}),
