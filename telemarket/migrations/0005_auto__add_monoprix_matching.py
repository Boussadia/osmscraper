...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('telemarket_monoprix_matching', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('telemarket_product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['telemarket.Product'])),
            ('monoprix_product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['monoprix.Product'])),
            ('score', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('telemarket', ['Monoprix_matching'])

        # Removing M2M table for field monoprix_products on 'Product'
        db.delete_table('telemarket_product_monoprix_products')


    def backwards(self, orm):
        # Deleting model 'Monoprix_matching'
        db.delete_table('telemarket_monoprix_matching')

        # Adding M2M table for field monoprix_products on 'Product'
        db.create_table('telemarket_product_monoprix_products', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_product', models.ForeignKey(orm['telemarket.product'], null=False)),
            ('to_product', models.ForeignKey(orm['monoprix.product'], null=False))
        ))
        db.create_unique('telemarket_product_monoprix_products', ['from_product_id', 'to_product_id'])
    ...
    models = {
        ...
        'telemarket.product': {
            ...
            'dalliz_brand': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'telemarket_brand_dalliz_brand'", 'null': 'True', 'to': "orm['dalliz.Brand']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_url': ('django.db.models.fields.CharField', [], {'max_length': '9999'}),
            'price': ('django.db.models.fields.FloatField', [], {}),
