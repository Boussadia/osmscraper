...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('telemarket_unit_dalliz_unit', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_unit', models.ForeignKey(orm['telemarket.unit'], null=False)),
            ('to_unit', models.ForeignKey(orm['dalliz.unit'], null=False))
        ))
        db.create_unique('telemarket_unit_dalliz_unit', ['from_unit_id', 'to_unit_id'])


    def backwards(self, orm):
        # Removing M2M table for field dalliz_unit on 'Unit'
        db.delete_table('telemarket_unit_dalliz_unit')
