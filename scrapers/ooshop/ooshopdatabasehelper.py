			...
			try:
				...
				if product['is_product']:
					...
					if 'information' in product:
						if 'Information' in product['information']:
							informations = product['information']['Information']
						else:
							informations = None

						if 'Conservation' in product['information']:
							conservation = product['information']['Conservation']
						else:
							conservation = None

						if 'origin' in product['information']:
							origine = product['information']['origin']
						else:
							origine = None

						if u"Conseils d'utilisation" in product['information']:
							conseils = product['information'][u"Conseils d'utilisation"]
						else:
							conseils = None

						if 'Ingredients' in product['information']:
							ingredients = product['information']['Ingredients']
						else:
							ingredients = None

						if 'Composition' in product['information']:
							composition = product['information']['Composition']
						else:
							composition = None

						if 'Avertissements' in product['information']:
				...
				print products, id_parent_category, shipping_area
