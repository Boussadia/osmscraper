...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_table('ooshop_newbrand', 'ooshop_brand')

        # Renaming model 'NewProduct'
        db.rename_table(u'ooshop_newproduct', u'ooshop_product')

        # Renaming M2M table for field tag on 'NewProduct'
        db.rename_table(u'ooshop_newproduct_tag', u'ooshop_product_tag')

        # Renaming M2M table for field categories on 'NewProduct'
        db.rename_table(u'ooshop_newproduct_categories', u'ooshop_product_categories')

        # Renaming M2M table for field dalliz_category on 'NewProduct'
        db.rename_table(u'ooshop_newproduct_dalliz_category', u'ooshop_product_dalliz_category')

        # Changing field 'History.product'
        db.alter_column(u'ooshop_history', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ooshop.Product']))

        # Changing field 'Cart_content.product'
        db.alter_column(u'ooshop_cart_content', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ooshop.Product']))

        # Rename column newproduct to product in ooshop_product_tag
        db.rename_column('ooshop_product_tag', 'newproduct_id', 'product_id')

        # Rename column newproduct to product in ooshop_product_tag
        db.rename_column('ooshop_product_categories', 'newproduct_id', 'product_id')

        # Rename column newproduct to product in ooshop_product_tag
        db.rename_column('ooshop_product_dalliz_category', 'newproduct_id', 'product_id')

        # Rename column newproduct to product in ooshop_product_tag
        db.rename_column('ooshop_promotion_content', 'newproduct_id', 'product_id')

    def backwards(self, orm):
        # Renaming model 'NewBrand'
        db.rename_table('ooshop_brand', 'ooshop_newbrand')

        # Renaming model 'NewProduct'
        db.rename_table(u'ooshop_product', 'ooshop_newproduct')

        # Renaming M2M table for field tag on 'NewProduct'
        db.rename_table(u'ooshop_product_tag', 'ooshop_newproduct_tag')

        # Renaming M2M table for field categories on 'NewProduct'
        db.rename_table(u'ooshop_product_categories', 'ooshop_newproduct_categories')

        # Renaming M2M table for field dalliz_category on 'NewProduct'
        db.rename_table(u'ooshop_product_dalliz_category', 'ooshop_newproduct_dalliz_category')


        # Changing field 'History.product'
        db.alter_column(u'ooshop_history', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ooshop.NewProduct']))

        # Changing field 'Cart_content.product'
        db.alter_column(u'ooshop_cart_content', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ooshop.NewProduct']))

        # Rename column newproduct to product in ooshop_product_tag
        db.rename_column('ooshop_newproduct_tag', 'product_id', 'newproduct_id')

        # Rename column newproduct to product in ooshop_product_tag
        db.rename_column('ooshop_newproduct_categories', 'product_id', 'newproduct_id')

        # Rename column newproduct to product in ooshop_product_tag
        db.rename_column('ooshop_newproduct_dalliz_category', 'product_id', 'newproduct_id')

        # Rename column newproduct to product in ooshop_product_tag
        db.rename_column('ooshop_promotion_content', 'product_id', 'newproduct_id')
