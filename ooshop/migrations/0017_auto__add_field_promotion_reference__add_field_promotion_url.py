...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Promotion.reference'
        db.add_column('ooshop_promotion', 'reference',
                      self.gf('django.db.models.fields.CharField')(max_length=9999, unique=True, null=True),
                      keep_default=False)

        # Adding field 'Promotion.url'
        db.add_column('ooshop_promotion', 'url',
                      self.gf('django.db.models.fields.CharField')(max_length=9999, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Promotion.reference'
        db.delete_column('ooshop_promotion', 'reference')

        # Deleting field 'Promotion.url'
        db.delete_column('ooshop_promotion', 'url')
