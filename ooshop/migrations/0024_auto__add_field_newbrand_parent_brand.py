...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'ooshop_newbrand', 'parent_brand',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ooshop.NewBrand'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewBrand.parent_brand'
        db.delete_column(u'ooshop_newbrand', 'parent_brand_id')
