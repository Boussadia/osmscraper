...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Category_final', fields ['name']
        db.create_unique('ooshop_category_final', ['name'])


        # Changing field 'Category_final.selector'
        db.alter_column('ooshop_category_final', 'selector', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
        # Adding unique constraint on 'Category_sub_level_2', fields ['name']
        db.create_unique('ooshop_category_sub_level_2', ['name'])


        # Changing field 'Category_sub_level_2.selector'
        db.alter_column('ooshop_category_sub_level_2', 'selector', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
        # Adding unique constraint on 'Category_sub_level_1', fields ['name']
        db.create_unique('ooshop_category_sub_level_1', ['name'])


        # Changing field 'Category_sub_level_1.selector'
        db.alter_column('ooshop_category_sub_level_1', 'selector', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):
        # Removing unique constraint on 'Category_sub_level_1', fields ['name']
        db.delete_unique('ooshop_category_sub_level_1', ['name'])

        # Removing unique constraint on 'Category_sub_level_2', fields ['name']
        db.delete_unique('ooshop_category_sub_level_2', ['name'])

        # Removing unique constraint on 'Category_final', fields ['name']
        db.delete_unique('ooshop_category_final', ['name'])


        # Changing field 'Category_final.selector'
        db.alter_column('ooshop_category_final', 'selector', self.gf('django.db.models.fields.CharField')(default=None, max_length=100))

        # Changing field 'Category_sub_level_2.selector'
        db.alter_column('ooshop_category_sub_level_2', 'selector', self.gf('django.db.models.fields.CharField')(default=None, max_length=100))

        # Changing field 'Category_sub_level_1.selector'
        db.alter_column('ooshop_category_sub_level_1', 'selector', self.gf('django.db.models.fields.CharField')(default=None, max_length=100))
