...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('ooshop_promotion', 'end', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Promotion.start'
        db.alter_column('ooshop_promotion', 'start', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Promotion.end'
        db.alter_column('ooshop_promotion', 'end', self.gf('django.db.models.fields.DateField')(default=None))

        # Changing field 'Promotion.start'
        db.alter_column('ooshop_promotion', 'start', self.gf('django.db.models.fields.DateField')(default=None))
