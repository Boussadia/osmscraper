...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Category_final.cookie'
        db.alter_column('ooshop_category_final', 'cookie', self.gf('django.db.models.fields.CharField')(max_length=10000, null=True))

        # Changing field 'Category_sub_level_2.cookie'
        db.alter_column('ooshop_category_sub_level_2', 'cookie', self.gf('django.db.models.fields.CharField')(max_length=10000, null=True))

        # Changing field 'Category_sub_level_1.cookie'
        db.alter_column('ooshop_category_sub_level_1', 'cookie', self.gf('django.db.models.fields.CharField')(max_length=10000, null=True))

    def backwards(self, orm):

        # Changing field 'Category_final.cookie'
        db.alter_column('ooshop_category_final', 'cookie', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Category_sub_level_2.cookie'
        db.alter_column('ooshop_category_sub_level_2', 'cookie', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Category_sub_level_1.cookie'
        db.alter_column('ooshop_category_sub_level_1', 'cookie', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
