...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ooshop_brand_dalliz_brand_m2m', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_brand', models.ForeignKey(orm['ooshop.brand'], null=False)),
            ('to_brand', models.ForeignKey(orm['dalliz.brand'], null=False))
        ))
        db.create_unique('ooshop_brand_dalliz_brand_m2m', ['from_brand_id', 'to_brand_id'])
