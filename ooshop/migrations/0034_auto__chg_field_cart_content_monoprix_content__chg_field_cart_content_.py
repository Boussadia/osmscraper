...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'ooshop_cart_content', 'monoprix_content_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['monoprix.Cart_content']))

        # Changing field 'Cart_content.auchan_content'
        db.alter_column(u'ooshop_cart_content', 'auchan_content_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auchan.Cart_content']))

    def backwards(self, orm):

        # Changing field 'Cart_content.monoprix_content'
        db.alter_column(u'ooshop_cart_content', 'monoprix_content_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['monoprix.Cart_content']))

        # Changing field 'Cart_content.auchan_content'
        db.alter_column(u'ooshop_cart_content', 'auchan_content_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auchan.Cart_content']))
