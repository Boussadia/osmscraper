...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ooshop_newproduct', (
            ...
            ('package_unit', self.gf('django.db.models.fields.FloatField')(null=True)),
        ))
        ...
        db.create_table('ooshop_history', (
            ...
            ('shipping_area', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ooshop.ShippingArea'])),
    ...
    models = {
        ...
        'ooshop.history': {
            ...
            'shipping_area': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ooshop.ShippingArea']"}),
        ...
        'ooshop.newproduct': {
            ...
            'package_unit': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
