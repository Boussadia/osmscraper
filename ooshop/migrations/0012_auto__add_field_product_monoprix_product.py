...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('ooshop_product', 'monoprix_product',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='ooshop_monoprix_product', null=True, to=orm['monoprix.Product']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.monoprix_product'
        db.delete_column('ooshop_product', 'monoprix_product_id')
