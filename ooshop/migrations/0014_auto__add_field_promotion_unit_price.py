...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Promotion.unit_price'
        db.add_column('ooshop_promotion', 'unit_price',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Promotion.unit_price'
        db.delete_column('ooshop_promotion', 'unit_price')
