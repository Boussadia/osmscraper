...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'ooshop_cart_content', 'osm_suggested_from',
                      self.gf('django.db.models.fields.CharField')(default='auchan', max_length=100),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'ooshop_cart_content', 'osm_suggested_from')
