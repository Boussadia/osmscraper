...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Promotion.availability'
        db.add_column('ooshop_promotion', 'availability',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Promotion.availability'
        db.delete_column('ooshop_promotion', 'availability')
