...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('ooshop_promotion', ['reference'])

        # Adding unique constraint on 'Promotion', fields ['shipping_area', 'reference']
        db.create_unique('ooshop_promotion', ['shipping_area_id', 'reference'])


    def backwards(self, orm):
        # Removing unique constraint on 'Promotion', fields ['shipping_area', 'reference']
        db.delete_unique('ooshop_promotion', ['shipping_area_id', 'reference'])

        # Adding unique constraint on 'Promotion', fields ['reference']
        db.create_unique('ooshop_promotion', ['reference'])
