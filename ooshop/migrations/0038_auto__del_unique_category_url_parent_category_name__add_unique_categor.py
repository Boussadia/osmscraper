...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'ooshop_category', ['url', 'parent_category_id', 'name'])

        # Adding unique constraint on 'Category', fields ['parent_category', 'name']
        db.create_unique(u'ooshop_category', ['parent_category_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Category', fields ['parent_category', 'name']
        db.delete_unique(u'ooshop_category', ['parent_category_id', 'name'])

        # Adding unique constraint on 'Category', fields ['url', 'parent_category', 'name']
        db.create_unique(u'ooshop_category', ['url', 'parent_category_id', 'name'])
