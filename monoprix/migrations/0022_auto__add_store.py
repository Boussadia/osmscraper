...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Store'
        db.create_table('monoprix_store', (
            ...
            ('phone', self.gf('django.db.models.fields.TextField')(null=True)),
            ('adress', self.gf('django.db.models.fields.TextField')(null=True)),
            ('chain', self.gf('django.db.models.fields.TextField')(null=True)),
            ('infos', self.gf('django.db.models.fields.TextField')(null=True)),
            ('icon', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('ctm', self.gf('django.db.models.fields.IntegerField')(null=True)),
        ))
        db.send_create_signal('monoprix', ['Store'])


    def backwards(self, orm):
        # Deleting model 'Store'
        db.delete_table('monoprix_store')
    ...
    models = {
        ...
        'monoprix.store': {
            ...
            'adress': ('django.db.models.fields.TextField', [], {'null': 'True'}),
