...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('monoprix_product_history', 'unit_id')


    def backwards(self, orm):
        # Adding field 'Product_history.unit'
        db.add_column('monoprix_product_history', 'unit',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['monoprix.Unit']),
                      keep_default=False)
