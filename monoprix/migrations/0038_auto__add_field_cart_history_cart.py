...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cart_history.cart'
        db.add_column(u'monoprix_cart_history', 'cart',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['monoprix.Cart']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cart_history.cart'
        db.delete_column(u'monoprix_cart_history', 'cart_id')
