...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewProduct.has_match'
        db.add_column(u'monoprix_newproduct', 'has_match',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewProduct.has_match'
        db.delete_column(u'monoprix_newproduct', 'has_match')
    ...
    models = {
        ...
        u'monoprix.user': {
            ...
            'cart': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['monoprix.Cart']", 'null': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
