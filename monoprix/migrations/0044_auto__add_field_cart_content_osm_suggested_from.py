...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'monoprix_cart_content', 'osm_suggested_from',
                      self.gf('django.db.models.fields.CharField')(default='ooshop', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cart_content.osm_suggested_from'
        db.delete_column(u'monoprix_cart_content', 'osm_suggested_from')
