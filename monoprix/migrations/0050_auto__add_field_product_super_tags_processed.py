...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.super_tags_processed'
        db.add_column(u'monoprix_product', 'super_tags_processed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.super_tags_processed'
        db.delete_column(u'monoprix_product', 'super_tags_processed')
    ...
    models = {
        ...
        u'auchan.product': {
            ...
            'super_tags_processed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
