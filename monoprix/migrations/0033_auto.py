...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('monoprix_newproduct_dalliz_category', (
        ...
        db.create_unique('monoprix_newproduct_dalliz_category', ['newproduct_id', 'category_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('monoprix_newproduct_dalliz_category')

        # Removing M2M table for field tag on 'NewProduct'
        db.delete_table('monoprix_newproduct_tag')
