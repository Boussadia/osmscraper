...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('monoprix_product', 'unit_price', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Product.price'
        db.alter_column('monoprix_product', 'price', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Product.promotion'
        db.alter_column('monoprix_product', 'promotion', self.gf('django.db.models.fields.CharField')(max_length=9999, null=True))

    def backwards(self, orm):

        # Changing field 'Product.unit_price'
        db.alter_column('monoprix_product', 'unit_price', self.gf('django.db.models.fields.FloatField')(default=None))

        # Changing field 'Product.price'
        db.alter_column('monoprix_product', 'price', self.gf('django.db.models.fields.FloatField')(default=None))

        # Changing field 'Product.promotion'
        db.alter_column('monoprix_product', 'promotion', self.gf('django.db.models.fields.CharField')(default=None, max_length=9999))
