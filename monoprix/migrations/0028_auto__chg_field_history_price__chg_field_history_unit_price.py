...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'History.price'
        db.alter_column('monoprix_history', 'price', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'History.unit_price'
        db.alter_column('monoprix_history', 'unit_price', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'History.price'
        db.alter_column('monoprix_history', 'price', self.gf('django.db.models.fields.FloatField')(default=None))

        # Changing field 'History.unit_price'
        db.alter_column('monoprix_history', 'unit_price', self.gf('django.db.models.fields.FloatField')(default=None))
