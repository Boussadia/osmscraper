...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.reference'
        db.alter_column('monoprix_product', 'reference', self.gf('django.db.models.fields.CharField')(default=None, unique=True, max_length=9999))
        # Adding unique constraint on 'Product', fields ['reference']
        db.create_unique('monoprix_product', ['reference'])


    def backwards(self, orm):
        # Removing unique constraint on 'Product', fields ['reference']
        db.delete_unique('monoprix_product', ['reference'])


        # Changing field 'Product.reference'
        db.alter_column('monoprix_product', 'reference', self.gf('django.db.models.fields.CharField')(max_length=9999, null=True))
