...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('monoprix_promotion', ['reference'])

        # Adding unique constraint on 'Promotion', fields ['store', 'reference']
        db.create_unique('monoprix_promotion', ['store_id', 'reference'])


    def backwards(self, orm):
        # Removing unique constraint on 'Promotion', fields ['store', 'reference']
        db.delete_unique('monoprix_promotion', ['store_id', 'reference'])

        # Adding unique constraint on 'Promotion', fields ['reference']
        db.create_unique('monoprix_promotion', ['reference'])
