...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Cart_content', fields ['product', 'cart']
        db.delete_unique(u'monoprix_cart_content', ['product_id', 'cart_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'Cart_content', fields ['product', 'cart']
        db.create_unique(u'monoprix_cart_content', ['product_id', 'cart_id'])
