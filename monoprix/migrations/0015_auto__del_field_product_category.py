...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('monoprix_product', 'category_id')


    def backwards(self, orm):
        # Adding field 'Product.category'
        db.add_column('monoprix_product', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['monoprix.Category_final']),
                      keep_default=False)
    ...
    models = {
        ...
        'monoprix.product': {
            ...
            'product_categpry': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'product_category'", 'symmetrical': 'False', 'to': "orm['monoprix.Category_final']"}),
