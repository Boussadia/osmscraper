...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'monoprix_cart_content', 'auchan_content_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auchan.Cart_content']))

        # Changing field 'Cart_content.ooshop_content'
        db.alter_column(u'monoprix_cart_content', 'ooshop_content_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['ooshop.Cart_content']))

    def backwards(self, orm):

        # Changing field 'Cart_content.auchan_content'
        db.alter_column(u'monoprix_cart_content', 'auchan_content_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auchan.Cart_content']))

        # Changing field 'Cart_content.ooshop_content'
        db.alter_column(u'monoprix_cart_content', 'ooshop_content_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['ooshop.Cart_content']))
