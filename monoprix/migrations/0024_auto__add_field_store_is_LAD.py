...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Store.is_LAD'
        db.add_column('monoprix_store', 'is_LAD',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Store.is_LAD'
        db.delete_column('monoprix_store', 'is_LAD')
    ...
    models = {
        ...
        'monoprix.store': {
            'Meta': {'unique_together': "(('name', 'city_name', 'postal_code', 'adress'),)", 'object_name': 'Store'},
