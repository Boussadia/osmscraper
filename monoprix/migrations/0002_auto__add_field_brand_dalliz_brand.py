...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Brand.dalliz_brand'
        db.add_column('monoprix_brand', 'dalliz_brand',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dalliz.Brand'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Brand.dalliz_brand'
        db.delete_column('monoprix_brand', 'dalliz_brand_id')
