...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('monoprix_category', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('parent_category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['monoprix.Category'], null=True)),
        ...
        db.send_create_signal('monoprix', ['Category'])

        # Adding unique constraint on 'Category', fields ['name', 'parent_category']
        db.create_unique('monoprix_category', ['name', 'parent_category_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Category', fields ['name', 'parent_category']
        db.delete_unique('monoprix_category', ['name', 'parent_category_id'])

        # Deleting model 'Category'
        db.delete_table('monoprix_category')
