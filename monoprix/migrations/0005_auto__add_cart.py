...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Cart'
        db.create_table('monoprix_cart', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('session_key', self.gf('django.db.models.fields.CharField')(max_length=1000)),
        ))
        db.send_create_signal('monoprix', ['Cart'])
    ...
    models = {
        ...
        'monoprix.cart': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'products': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['monoprix.Product']", 'symmetrical': 'False'}),
            'session_key': ('django.db.models.fields.CharField', [], {'max_length': '1000'})
        },
