...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'monoprix_product', 'has_match')

        # Adding field 'Product.processed'
        db.add_column(u'monoprix_product', 'processed',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'monoprix_product', 'has_match',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Product.processed'
        db.delete_column(u'monoprix_product', 'processed')
