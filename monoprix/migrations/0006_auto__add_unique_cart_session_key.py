...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Cart', fields ['session_key']
        db.create_unique('monoprix_cart', ['session_key'])


    def backwards(self, orm):
        # Removing unique constraint on 'Cart', fields ['session_key']
        db.delete_unique('monoprix_cart', ['session_key'])
