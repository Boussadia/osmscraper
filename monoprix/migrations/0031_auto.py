...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('monoprix_category_dalliz_category', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_category', models.ForeignKey(orm['monoprix.category'], null=False)),
            ('to_category', models.ForeignKey(orm['dalliz.category'], null=False))
        ))
        db.create_unique('monoprix_category_dalliz_category', ['from_category_id', 'to_category_id'])


    def backwards(self, orm):
        # Removing M2M table for field dalliz_category on 'Category'
        db.delete_table('monoprix_category_dalliz_category')
