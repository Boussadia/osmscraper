...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewBrand.parent_brand'
        db.add_column('monoprix_newbrand', 'parent_brand',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['monoprix.NewBrand'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewBrand.parent_brand'
        db.delete_column('monoprix_newbrand', 'parent_brand_id')
