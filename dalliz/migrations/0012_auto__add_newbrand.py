...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('dalliz_newbrand', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('parent_brand', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dalliz.NewBrand'], null=True)),
        ))
        db.send_create_signal('dalliz', ['NewBrand'])


    def backwards(self, orm):
        # Deleting model 'NewBrand'
        db.delete_table('dalliz_newbrand')
